...
urlpatterns = [
    ...
    path('mobile/get_mapdata/<slug:map_title>', views.get_mapdata, name='getmapdata'),
    ...
    path('mobile/list/<slug:user_name>/', views.show_list_mobile, name='showlistmobile'),
    ...
    path('mobile/<int:map_id>', views.show_my_map_mobile, name='showmymapmobile'),
